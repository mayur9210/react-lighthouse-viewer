'use strict'; // auto-generated by build/build-report-components.js
...
function create3pFilterComponent(dom) {
  var el0 = dom.createFragment();
  var el1 = dom.createElement('style');
  el1.append('\n    .lh-3p-filter {\n      color: var(--color-gray-600);\n      float: right;\n      padding: 6px var(--stackpack-padding-horizontal);\n    }\n    .lh-3p-filter-label, .lh-3p-filter-input {\n      vertical-align: middle;\n      user-select: none;\n    }\n    .lh-3p-filter-input:disabled + .lh-3p-ui-string {\n      text-decoration: line-through;\n    }\n  ');
  el0.append(el1);
  var el2 = dom.createElement('div', 'lh-3p-filter');
  var el3 = dom.createElement('label', 'lh-3p-filter-label');
  var el4 = dom.createElement('input', 'lh-3p-filter-input');
  el4.setAttribute('type', 'checkbox');
  el4.setAttribute('checked', '');
  var el5 = dom.createElement('span', 'lh-3p-ui-string');
  el5.append('Show 3rd party resources');
  var el6 = dom.createElement('span', 'lh-3p-filter-count');
...
function createAuditComponent(dom) {
  var el0 = dom.createFragment();
  var el1 = dom.createElement('div', 'lh-audit');
  var el2 = dom.createElement('details', 'lh-expandable-details');
  var el3 = dom.createElement('summary');
  var el4 = dom.createElement('div', 'lh-audit__header lh-expandable-details__summary');
  var el5 = dom.createElement('span', 'lh-audit__score-icon');
  var el6 = dom.createElement('span', 'lh-audit__title-and-text');
  var el7 = dom.createElement('span', 'lh-audit__title');
  var el8 = dom.createElement('span', 'lh-audit__display-text');
  el6.append(' ', el7, ' ', el8, ' ');
  var el9 = dom.createElement('div', 'lh-chevron-container');
  el4.append(' ', el5, ' ', el6, ' ', el9, ' ');
  el3.append(' ', el4, ' ');
  var el10 = dom.createElement('div', 'lh-audit__description');
  var el11 = dom.createElement('div', 'lh-audit__stackpacks');
...
function createCategoryHeaderComponent(dom) {
  var el0 = dom.createFragment();
  var el1 = dom.createElement('div', 'lh-category-header');
  var el2 = dom.createElement('div', 'lh-score__gauge');
  el2.setAttribute('role', 'heading');
  el2.setAttribute('aria-level', '2');
  var el3 = dom.createElement('div', 'lh-category-header__description');
  el1.append(' ', el2, ' ', el3, ' ');
  el0.append(el1);
  return el0;
}
...
function createChevronComponent(dom) {
  var el0 = dom.createFragment();
  var el1 = dom.createElementNS('http://www.w3.org/2000/svg', 'svg', 'lh-chevron');
  el1.setAttribute('viewBox', '0 0 100 100');
  var el2 = dom.createElementNS('http://www.w3.org/2000/svg', 'g', 'lh-chevron__lines');
  var el3 = dom.createElementNS('http://www.w3.org/2000/svg', 'path', 'lh-chevron__line lh-chevron__line-left');
  el3.setAttribute('d', 'M10 50h40');
  var el4 = dom.createElementNS('http://www.w3.org/2000/svg', 'path', 'lh-chevron__line lh-chevron__line-right');
...
function createClumpComponent(dom) {
  var el0 = dom.createFragment();
  var el1 = dom.createElement('div', 'lh-audit-group');
  var el2 = dom.createElement('details', 'lh-clump');
  var el3 = dom.createElement('summary');
  var el4 = dom.createElement('div', 'lh-audit-group__summary');
  var el5 = dom.createElement('div', 'lh-audit-group__header');
  var el6 = dom.createElement('span', 'lh-audit-group__title');
  var el7 = dom.createElement('span', 'lh-audit-group__itemcount');
  el5.append(' ', el6, ' ', el7, ' ', ' ', ' ');
  var el8 = dom.createElement('div', 'lh-clump-toggle');
  var el9 = dom.createElement('span', 'lh-clump-toggletext--show');
  var el10 = dom.createElement('span', 'lh-clump-toggletext--hide');
  el8.append(' ', el9, ' ', el10, ' ');
  el4.append(' ', el5, ' ', el8, ' ');
  el3.append(' ', el4, ' ');
  el2.append(' ', el3, ' ');
...
function createCrcComponent(dom) {
  var el0 = dom.createFragment();
  var el1 = dom.createElement('div', 'lh-crc-container');
  ...
  var el4 = dom.createElement('div', 'lh-crc__summary-value');
  var el5 = dom.createElement('span', 'lh-crc__longest_duration_label');
  var el6 = dom.createElement('b', 'lh-crc__longest_duration');
  el4.append(' ', el5, ' ', el6, ' ');
  el3.append(' ', el4, ' ');
  var el7 = dom.createElement('div', 'lh-crc');
  var el8 = dom.createElement('div', 'lh-crc-initial-nav');
  el7.append(' ', el8, ' ', ' ');
...
function createCrcChainComponent(dom) {
  var el0 = dom.createFragment();
  var el1 = dom.createElement('div', 'lh-crc-node');
  var el2 = dom.createElement('span', 'lh-crc-node__tree-marker');
  var el3 = dom.createElement('span', 'lh-crc-node__tree-value');
  el1.append(' ', el2, ' ', el3, ' ');
  el0.append(el1);
  return el0;
}
...
function createElementScreenshotComponent(dom) {
  var el0 = dom.createFragment();
  var el1 = dom.createElement('div', 'lh-element-screenshot');
  var el2 = dom.createElement('div', 'lh-element-screenshot__content');
  var el3 = dom.createElement('div', 'lh-element-screenshot__mask');
  var el4 = dom.createElementNS('http://www.w3.org/2000/svg', 'svg');
  el4.setAttribute('height', '0');
  el4.setAttribute('width', '0');
  var el5 = dom.createElementNS('http://www.w3.org/2000/svg', 'defs');
  var el6 = dom.createElementNS('http://www.w3.org/2000/svg', 'clipPath');
  el6.setAttribute('clipPathUnits', 'objectBoundingBox');
  el5.append(' ', el6, ' ', ' ');
  el4.append(' ', el5, ' ');
  el3.append(' ', el4, ' ');
  var el7 = dom.createElement('div', 'lh-element-screenshot__image');
  var el8 = dom.createElement('div', 'lh-element-screenshot__element-marker');
...
function createFooterComponent(dom) {
  ...
  el0.append(el1);
  var el2 = dom.createElement('footer', 'lh-footer');
  var el3 = dom.createElement('ul', 'lh-meta__items');
  el3.append(' ');
  var el4 = dom.createElement('div', 'lh-generated');
  var el5 = dom.createElement('b');
  el5.append('Lighthouse');
  var el6 = dom.createElement('span', 'lh-footer__version');
  var el7 = dom.createElement('a', 'lh-footer__version_issue');
...
function createFractionComponent(dom) {
  var el0 = dom.createFragment();
  var el1 = dom.createElement('a', 'lh-fraction__wrapper');
  var el2 = dom.createElement('div', 'lh-fraction__content-wrapper');
  var el3 = dom.createElement('div', 'lh-fraction__content');
  var el4 = dom.createElement('div', 'lh-fraction__background');
  el3.append(' ', el4, ' ');
  el2.append(' ', el3, ' ');
  var el5 = dom.createElement('div', 'lh-fraction__label');
  el1.append(' ', el2, ' ', el5, ' ');
  el0.append(el1);
  return el0;
}
...
function createGaugeComponent(dom) {
  var el0 = dom.createFragment();
  var el1 = dom.createElement('a', 'lh-gauge__wrapper');
  var el2 = dom.createElement('div', 'lh-gauge__svg-wrapper');
  var el3 = dom.createElementNS('http://www.w3.org/2000/svg', 'svg', 'lh-gauge');
  el3.setAttribute('viewBox', '0 0 120 120');
  var el4 = dom.createElementNS('http://www.w3.org/2000/svg', 'circle', 'lh-gauge-base');
  el4.setAttribute('r', '56');
  el4.setAttribute('cx', '60');
  el4.setAttribute('cy', '60');
  el4.setAttribute('stroke-width', '8');
  var el5 = dom.createElementNS('http://www.w3.org/2000/svg', 'circle', 'lh-gauge-arc');
  ...
  el3.append(' ', el4, ' ', el5, ' ');
  el2.append(' ', el3, ' ');
  var el6 = dom.createElement('div', 'lh-gauge__percentage');
  var el7 = dom.createElement('div', 'lh-gauge__label');
...
function createGaugePwaComponent(dom) {
  ...
  el0.append(el1);
  var el2 = dom.createElement('a', 'lh-gauge__wrapper lh-gauge--pwa__wrapper');
  var el3 = dom.createElementNS('http://www.w3.org/2000/svg', 'svg', 'lh-gauge lh-gauge--pwa');
  el3.setAttribute('viewBox', '0 0 60 60');
  var el4 = dom.createElementNS('http://www.w3.org/2000/svg', 'defs');
  var el5 = dom.createElementNS('http://www.w3.org/2000/svg', 'linearGradient');
  ...
  var el6 = dom.createElementNS('http://www.w3.org/2000/svg', 'stop');
  el6.setAttribute('stop-color', '#00C852');
  el6.setAttribute('offset', '0%');
  var el7 = dom.createElementNS('http://www.w3.org/2000/svg', 'stop');
  el7.setAttribute('stop-color', '#009688');
  el7.setAttribute('offset', '100%');
  el5.append(' ', el6, ' ', el7, ' ');
  var el8 = dom.createElementNS('http://www.w3.org/2000/svg', 'linearGradient');
  ...
  var el9 = dom.createElementNS('http://www.w3.org/2000/svg', 'stop');
  el9.setAttribute('stop-color', '#A5D6A7');
  el9.setAttribute('offset', '0%');
  var el10 = dom.createElementNS('http://www.w3.org/2000/svg', 'stop');
  el10.setAttribute('stop-color', '#80CBC4');
  el10.setAttribute('offset', '100%');
  el8.append(' ', el9, ' ', el10, ' ');
  var el11 = dom.createElementNS('http://www.w3.org/2000/svg', 'g');
  el11.setAttribute('id', 'lh-gauge--pwa__installable-badge');
  var el12 = dom.createElementNS('http://www.w3.org/2000/svg', 'circle');
  el12.setAttribute('fill', '#FFFFFF');
  el12.setAttribute('cx', '10');
  el12.setAttribute('cy', '10');
  el12.setAttribute('r', '10');
  var el13 = dom.createElementNS('http://www.w3.org/2000/svg', 'path');
  ...
  var el14 = dom.createElementNS('http://www.w3.org/2000/svg', 'g');
  el14.setAttribute('stroke', 'none');
  el14.setAttribute('fill-rule', 'nonzero');
  var el15 = dom.createElementNS('http://www.w3.org/2000/svg', 'circle', 'lh-gauge--pwa__disc');
  el15.setAttribute('cx', '30');
  el15.setAttribute('cy', '30');
  el15.setAttribute('r', '30');
  var el16 = dom.createElementNS('http://www.w3.org/2000/svg', 'g', 'lh-gauge--pwa__logo');
  var el17 = dom.createElementNS('http://www.w3.org/2000/svg', 'path', 'lh-gauge--pwa__logo--secondary-color');
  el17.setAttribute('d', 'M35.66 19.39l.7-1.75h2L37.4 15 38.6 12l3.4 9h-2.51l-.58-1.61z');
  var el18 = dom.createElementNS('http://www.w3.org/2000/svg', 'path', 'lh-gauge--pwa__logo--primary-color');
  ...
  var el19 = dom.createElementNS('http://www.w3.org/2000/svg', 'path', 'lh-gauge--pwa__logo--secondary-color');
  ...
  var el20 = dom.createElementNS('http://www.w3.org/2000/svg', 'rect', 'lh-gauge--pwa__component lh-gauge--pwa__na-line');
  ...
  var el21 = dom.createElementNS('http://www.w3.org/2000/svg', 'g', 'lh-gauge--pwa__component lh-gauge--pwa__installable-badge');
  el21.setAttribute('transform', 'translate(20, 29)');
  var el22 = dom.createElementNS('http://www.w3.org/2000/svg', 'path');
  ...
  var el23 = dom.createElementNS('http://www.w3.org/2000/svg', 'use');
  el23.setAttribute('href', '#lh-gauge--pwa__installable-badge');
  el21.append(' ', el22, ' ', el23, ' ');
  var el24 = dom.createElementNS('http://www.w3.org/2000/svg', 'g', 'lh-gauge--pwa__component lh-gauge--pwa__check-circle');
  el24.setAttribute('transform', 'translate(18, 28)');
  var el25 = dom.createElementNS('http://www.w3.org/2000/svg', 'circle');
  el25.setAttribute('fill', '#FFFFFF');
  el25.setAttribute('cx', '12');
  el25.setAttribute('cy', '12');
  el25.setAttribute('r', '12');
  var el26 = dom.createElementNS('http://www.w3.org/2000/svg', 'path');
  ...
  el3.append(' ', el4, ' ', el14, ' ');
  var el27 = dom.createElement('div', 'lh-gauge__label');
  el2.append(' ', el3, ' ', el27, ' ');
  el0.append(el2);
  return el0;
}
...
function createHeadingComponent(dom) {
  ...
  el0.append(el1);
  var el2 = dom.createElement('div', 'lh-header-container');
  var el3 = dom.createElement('div', 'lh-scores-wrapper-placeholder');
  el2.append(' ', el3, ' ');
  el0.append(el2);
  return el0;
}
...
function createMetricComponent(dom) {
  var el0 = dom.createFragment();
  var el1 = dom.createElement('div', 'lh-metric');
  var el2 = dom.createElement('div', 'lh-metric__innerwrap');
  var el3 = dom.createElement('div', 'lh-metric__icon');
  var el4 = dom.createElement('span', 'lh-metric__title');
  var el5 = dom.createElement('div', 'lh-metric__value');
  var el6 = dom.createElement('div', 'lh-metric__description');
...
function createOpportunityComponent(dom) {
  var el0 = dom.createFragment();
  var el1 = dom.createElement('div', 'lh-audit lh-audit--load-opportunity');
  var el2 = dom.createElement('details', 'lh-expandable-details');
  var el3 = dom.createElement('summary');
  var el4 = dom.createElement('div', 'lh-audit__header');
  var el5 = dom.createElement('div', 'lh-load-opportunity__cols');
  var el6 = dom.createElement('div', 'lh-load-opportunity__col lh-load-opportunity__col--one');
  var el7 = dom.createElement('span', 'lh-audit__score-icon');
  var el8 = dom.createElement('div', 'lh-audit__title');
  el6.append(' ', el7, ' ', el8, ' ');
  var el9 = dom.createElement('div', 'lh-load-opportunity__col lh-load-opportunity__col--two');
  var el10 = dom.createElement('div', 'lh-load-opportunity__sparkline');
  var el11 = dom.createElement('div', 'lh-sparkline');
  var el12 = dom.createElement('div', 'lh-sparkline__bar');
  el11.append(el12);
  el10.append(' ', el11, ' ');
  var el13 = dom.createElement('div', 'lh-audit__display-text');
  var el14 = dom.createElement('div', 'lh-chevron-container');
  el9.append(' ', el10, ' ', el13, ' ', el14, ' ');
  el5.append(' ', el6, ' ', el9, ' ');
  el4.append(' ', el5, ' ');
  el3.append(' ', el4, ' ');
  var el15 = dom.createElement('div', 'lh-audit__description');
  var el16 = dom.createElement('div', 'lh-audit__stackpacks');
...
function createOpportunityHeaderComponent(dom) {
  var el0 = dom.createFragment();
  var el1 = dom.createElement('div', 'lh-load-opportunity__header lh-load-opportunity__cols');
  var el2 = dom.createElement('div', 'lh-load-opportunity__col lh-load-opportunity__col--one');
  var el3 = dom.createElement('div', 'lh-load-opportunity__col lh-load-opportunity__col--two');
  el1.append(' ', el2, ' ', el3, ' ');
  el0.append(el1);
  return el0;
}
...
function createScorescaleComponent(dom) {
  var el0 = dom.createFragment();
  var el1 = dom.createElement('div', 'lh-scorescale');
  var el2 = dom.createElement('span', 'lh-scorescale-range lh-scorescale-range--fail');
  el2.append('0–49');
  var el3 = dom.createElement('span', 'lh-scorescale-range lh-scorescale-range--average');
  el3.append('50–89');
  var el4 = dom.createElement('span', 'lh-scorescale-range lh-scorescale-range--pass');
  el4.append('90–100');
...
function createScoresWrapperComponent(dom) {
  ...
  el0.append(el1);
  var el2 = dom.createElement('div', 'lh-scores-wrapper');
  var el3 = dom.createElement('div', 'lh-scores-container');
  var el4 = dom.createElement('div', 'lh-pyro');
  var el5 = dom.createElement('div', 'lh-before');
  var el6 = dom.createElement('div', 'lh-after');
  el4.append(' ', el5, ' ', el6, ' ');
  el3.append(' ', el4, ' ');
  el2.append(' ', el3, ' ');
  el0.append(el2);
...
function createSnippetComponent(dom) {
  var el0 = dom.createFragment();
  var el1 = dom.createElement('div', 'lh-snippet');
  var el2 = dom.createElement('style');
...
function createSnippetContentComponent(dom) {
  var el0 = dom.createFragment();
  var el1 = dom.createElement('div', 'lh-snippet__snippet');
  var el2 = dom.createElement('div', 'lh-snippet__snippet-inner');
  el1.append(' ', el2, ' ');
  el0.append(el1);
  return el0;
}
...
function createSnippetHeaderComponent(dom) {
  var el0 = dom.createFragment();
  var el1 = dom.createElement('div', 'lh-snippet__header');
  var el2 = dom.createElement('div', 'lh-snippet__title');
  var el3 = dom.createElement('div', 'lh-snippet__node');
  var el4 = dom.createElement('button', 'lh-snippet__toggle-expand');
  var el5 = dom.createElement('span', 'lh-snippet__btn-label-collapse lh-snippet__show-if-expanded');
  var el6 = dom.createElement('span', 'lh-snippet__btn-label-expand lh-snippet__show-if-collapsed');
  el4.append(' ', el5, ' ', el6, ' ');
  el1.append(' ', el2, ' ', el3, ' ', el4, ' ');
  el0.append(el1);
  return el0;
...
function createSnippetLineComponent(dom) {
  var el0 = dom.createFragment();
  var el1 = dom.createElement('div', 'lh-snippet__line');
  var el2 = dom.createElement('div', 'lh-snippet__line-number');
  var el3 = dom.createElement('div', 'lh-snippet__line-icon');
...
function createTopbarComponent(dom) {
  ...
  el0.append(el1);
  var el2 = dom.createElement('div', 'lh-topbar');
  var el3 = dom.createElementNS('http://www.w3.org/2000/svg', 'svg', 'lh-topbar__logo');
  ...
  el10.setAttribute('offset', '100%');
  el8.append(' ', el9, ' ', el10, ' ');
  var el11 = dom.createElementNS('http://www.w3.org/2000/svg', 'linearGradient');
  ...
  var el15 = dom.createElementNS('http://www.w3.org/2000/svg', 'stop');
  el15.setAttribute('stop-color', '#FFF');
  el15.setAttribute('stop-opacity', '.1');
  el15.setAttribute('offset', '0%');
  var el16 = dom.createElementNS('http://www.w3.org/2000/svg', 'stop');
  ...
  var el17 = dom.createElementNS('http://www.w3.org/2000/svg', 'g');
  el17.setAttribute('fill', 'none');
  el17.setAttribute('fill-rule', 'evenodd');
  var el18 = dom.createElementNS('http://www.w3.org/2000/svg', 'path');
  ...
  var el19 = dom.createElementNS('http://www.w3.org/2000/svg', 'path');
  el19.setAttribute('fill', '#FFF');
  el19.setAttribute('d', 'M14.201 12.938L9.54 14.633 9 18.028l5.625-2.062z');
  var el20 = dom.createElementNS('http://www.w3.org/2000/svg', 'path');
  ...
  var el21 = dom.createElementNS('http://www.w3.org/2000/svg', 'path');
  ...
  var el23 = dom.createElementNS('http://www.w3.org/2000/svg', 'path');
  ...
  var el24 = dom.createElementNS('http://www.w3.org/2000/svg', 'path');
  ...
  el3.append(' ', el4, ' ', el17, ' ');
  var el25 = dom.createElement('a', 'lh-topbar__url');
  el25.setAttribute('href', '');
  el25.setAttribute('target', '_blank');
  el25.setAttribute('rel', 'noopener');
  var el26 = dom.createElement('div', 'lh-tools');
  var el27 = dom.createElement('div', 'lh-tools-locale lh-hidden');
  var el28 = dom.createElement('button', 'lh-button lh-tool-locale__button');
  ...
  var el29 = dom.createElementNS('http://www.w3.org/2000/svg', 'svg');
  ...
  var el30 = dom.createElementNS('http://www.w3.org/2000/svg', 'path');
  el30.setAttribute('d', 'M0 0h24v24H0V0z');
  el30.setAttribute('fill', 'none');
  var el31 = dom.createElementNS('http://www.w3.org/2000/svg', 'path');
  ...
  el28.append(' ', el29, ' ');
  var el32 = dom.createElement('div', 'lh-tools-locale__selector-wrapper');
  ...
  var el33 = dom.createElement('button', 'lh-tools__button');
  ...
  var el34 = dom.createElementNS('http://www.w3.org/2000/svg', 'svg');
  el34.setAttribute('width', '100%');
  el34.setAttribute('height', '100%');
  el34.setAttribute('viewBox', '0 0 24 24');
  var el35 = dom.createElementNS('http://www.w3.org/2000/svg', 'path');
  el35.setAttribute('d', 'M0 0h24v24H0z');
  el35.setAttribute('fill', 'none');
  var el36 = dom.createElementNS('http://www.w3.org/2000/svg', 'path');
  ...
  var el39 = dom.createElement('a', 'lh-report-icon lh-report-icon--print');
  ...
  var el40 = dom.createElement('a', 'lh-report-icon lh-report-icon--copy');
  ...
  var el41 = dom.createElement('a', 'lh-report-icon lh-report-icon--download lh-hidden');
  ...
  var el42 = dom.createElement('a', 'lh-report-icon lh-report-icon--download');
  ...
  var el43 = dom.createElement('a', 'lh-report-icon lh-report-icon--open');
  ...
  var el44 = dom.createElement('a', 'lh-report-icon lh-report-icon--open');
  ...
  var el45 = dom.createElement('a', 'lh-report-icon lh-report-icon--dark');
...
function createWarningsToplevelComponent(dom) {
  var el0 = dom.createFragment();
  var el1 = dom.createElement('div', 'lh-warnings lh-warnings--toplevel');
  var el2 = dom.createElement('p', 'lh-warnings__msg');
...
function createComponent(dom, componentName) {
  switch (componentName) {
    ...
    case 'opportunity':
      return createOpportunityComponent(dom);

    case 'opportunityHeader':
      return createOpportunityHeaderComponent(dom);
